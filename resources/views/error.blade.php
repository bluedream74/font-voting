...
<body id="kt_body" class="app-blank bgi-size-cover bgi-position-center bgi-no-repeat">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <style>
            body {
                background-image: url('https://preview.keenthemes.com/metronic8/demo1/assets/media/auth/bg1.jpg');
            }

            [data-bs-theme="dark"] body {
                background-image: url('https://preview.keenthemes.com/metronic8/demo1/assets/media/auth/bg1-dark.jpg');
            }
        </style>
        <!--end::Page bg image-->
            ...
            <div class="d-flex flex-column flex-center text-center p-10">
                ...
                <div class="card card-flush w-lg-650px py-5">
                    <div class="card-body py-15 py-lg-20">
                        ...
                        <!--begin::Illustration-->
                        <div class="mb-3">
                            <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/auth/404-error.png"
                                class="mw-100 mh-300px theme-light-show" alt="" />
                            <img src="https://preview.keenthemes.com/metronic8/demo1/assets/media/auth/404-error-dark.png"
