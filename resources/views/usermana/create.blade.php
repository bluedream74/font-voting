    ...
    <div id="kt_app_content" class="app-content  flex-column-fluid ">
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            ...
            <div class="card ">
                ...
                @endif
                <!--begin::Card body-->
                <form class="card-body p-0 pt-10" action="{{ route('matching.store') }}" method="POST">
                    @csrf
                    <div class="row px-5">
                        <div class="col-lg-6">
                            <div class="p-5">
                                <label for="exampleFormControlInput1" class="form-label">タイトル</label>
                                <input type="text" name="title" class="form-control form-control-solid" placeholder="" required />
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row px-5">
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <input type="date" name="start_date" class="form-control form-control-solid" placeholder="" required />
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="p-5">
                                <label for="exampleFormControlInput1" class="form-label">終了日</label>
                                <input type="date" name="end_date" class="form-control form-control-solid" placeholder="" required />
                            </div>
                        </div>
                    </div>
                    <div class="row px-5">
