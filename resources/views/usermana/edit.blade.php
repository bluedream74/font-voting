    ...
    <div id="kt_app_content" class="app-content  flex-column-fluid ">
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            ...
            <div class="card ">
                ...
                @endif
                <!--begin::Card body-->
                <form class="card-body p-0 pt-10" action="{{ route('userMana.update', ['userMana' => $usermana->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row px-5">
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <input type="text" name="firstname" class="form-control form-control-solid" placeholder="" value="{{ $usermana->firstname }}" />
                            </div>
                        </div>
                        <div class="col-lg-6">
                    ...
                    <div class="row px-5">
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <input type="date" name="lastname" class="form-control form-control-solid" placeholder="" value="{{ $usermana->lastname}}" />
                            </div>
                        </div>
                         <div class="col-lg-6">
                            <div class="p-5">
                                <label for="exampleFormControlInput1" class="form-label">nickname</label>
                                <input type="date" name="nickname" class="form-control form-control-solid" placeholder="" value="{{ $usermana->nickname}}" />
                            </div>
                        </div>                        
                    </div>
                    <div class="row px-5">
