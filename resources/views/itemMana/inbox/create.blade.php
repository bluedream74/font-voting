        ...
        <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
            ...
            <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                ...
                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">作品登録</h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
            </div>
                        ...
                        <form class="mb-17" method="POST" action="{{ route('myItem.store') }}">
                            ...
                            <div class="row g-10 mb-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="image-input image-input-outline w-100" data-kt-image-input="true">
                                        ...
                                        <div class="image-input-wrapper w-100" style="background-image: url(https://www.nbmchealth.com/wp-content/uploads/2018/04/default-placeholder.png);"></div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="row g-10 mb-2">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <input type="text" name="title" id="title" class="form-control form-control-lg form-control-solid" placeholder="タイトル" value="{{ old('title') }}" />
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                    ...
                                    <div class="row g-10 mb-6">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <textarea name="description" id="description" cols="30" rows="6" class="form-control form-control-lg form-control-solid" value="">{{ old('description') }}</textarea>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <select aria-label="選択" id="frontal_color" name="frontal_color" data-control="select2" data-placeholder="選択" class="form-select form-select-solid form-select-lg">
                                                ...
                                                @foreach ($frontal_colors as $frontal_color)
                                                    <option data-kt-flag="flags/united-states.svg" value="{{ $frontal_color->id }}" {{ old('frontal_color') == $frontal_color->id ? 'selected' : '' }}>{{ $frontal_color->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <select aria-label="選択" id="category" name="category" data-control="select2" data-placeholder="選択" class="form-select form-select-solid form-select-lg">
                                                ...
                                                @foreach ($categories as $category)
                                                    <option data-kt-flag="flags/united-states.svg" value="{{ $category->id }}" {{ old('category') == $category->id ? 'selected' : '' }}>{{ $category->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                    ...
                                    <div class="row g-10 mb-2">
                                        <!--begin::Label-->
                                        <label class="col-lg-4 col-form-label fw-semibold fs-6" for="matching">
                                            <span class="required">マッチング</span>
                                        </label>
                                        <!--end::Label-->
                                        
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <select aria-label="選択" id="matching" name="matching" data-control="select2" data-placeholder="選択" class="form-select form-select-solid form-select-lg">
                                                <option value="">選択</option>
                                                @foreach ($matchings as $matching)
                                                    <option data-kt-flag="flags/united-states.svg" value="{{ $matching->id }}" {{ old('matching') == $matching->id ? 'selected' : '' }}>{{ $matching->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                    ...
                                    <div class="row g-10 mb-2">
                                        ...
                                        <!--begin::Col-->
                                        <div class="col-lg-8 fv-row">
                                            <select aria-label="選択" id="join_type" name="join_type" data-control="select2" data-placeholder="選択" class="form-select form-select-solid form-select-lg">
                                                <option data-kt-flag="flags/united-states.svg" value="0" {{ old('join_type') == 0 ? 'selected' : '' }}>いいえ</option>
                                                <option data-kt-flag="flags/united-states.svg" value="1" {{ old('join_type') == 1 ? 'selected' : '' }}>はい</option>
                                            </select>
                                        </div>
                                        <!--end::Col-->
                                    </div>
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-0">
                                <button type="submit" class="btn btn-primary py-2" id="kt_account_profile_details_submit">セーブ</button>
                            </div>
                        </form>
                        <!--end::Section-->
