    ...
    <div class="app-toolbar py-3 py-lg-6 ">
        ...
        <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                <!--begin::Title-->
                <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">作品詳細を見る
                </h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ route('myItem.edit', ['myItem' => $myItem->id]) }}"
                    class="btn btn-sm fw-bold btn-primary">編集</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                                    ...
                                    <div class="mb-8">
                                        ...
                                        <div class="d-flex flex-wrap mb-6">
                                            ...
                                            <div class="me-9 my-1">
                                                ...
                                                <span class="fw-bold text-gray-400">{{
                                                    $myItem->created_at->format('Y-m-d') }}</span>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Item-->
                                            ...
                                            <div class="my-1">
                                                ...
                                                <span class="fw-bold text-gray-400">
                                                    @php
                                                    $comment_row = DB::table('item_user')->where('item_id',
                                                    $myItem->id)->where('comment', '!=', '')->get();
                                        ...
                                        <div class="overlay mt-8 w-100">
                                            <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff"
                                                class="swiper mySwiper2 w-100">
                                                <div class="swiper-wrapper w-100">
                                                    <div class="swiper-slide w-100">
                                                        <img class="w-100 rounded equal-height1"
                                                            src="{{ asset($myItem->front_img) }}" />
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <img class="w-100 rounded equal-height1"
                                                            src="{{ asset($myItem->back_img) }}" />
                                                    </div>
                                                    <div class="swiper-slide">
                                                        <img class="w-100 rounded equal-height1"
                                                            src="{{ asset($myItem->side_img) }}" />
                                                    </div>
                                                </div>
                                            ...
                                            <div thumbsSlider="" class="swiper mySwiper w-100">
                                                <div class="swiper-wrapper d-flex justify-content-between w-100">
                                                    <div class="swiper-slide m-0">
                                                        <img class="rounded equal-height2"
                                                            src="{{ asset($myItem->front_img) }}" />
                                                    </div>
                                                    <div class="swiper-slide m-0">
                                                        <img class="rounded equal-height2"
                                    ...
                                    <div
                                        ...
                                        <div class="mb-0 fs-6">
                                            <div class="text-muted fw-semibold lh-lg mb-2">
                                                @php
                                                $comment_row = DB::table('item_user')->where('user_id',
                                                $comment_user->id)->where('item_id', $myItem->id)->where('comment',
                                                '!=', '')->first();
