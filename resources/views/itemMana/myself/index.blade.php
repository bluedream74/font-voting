        ...
        <div id="kt_app_content_container" class="app-container  container-xxl "
            ...
            <div class="d-flex flex-column flex-lg-row" data-select2-id="select2-data-132-7bgl">
                ...
                <div class="flex-column flex-lg-row-auto w-100 w-lg-250px w-xxl-325px mb-8 mb-lg-0 me-lg-9 me-5"
                    data-select2-id="select2-data-143-977q">
                    <!--begin::Form-->
                    <div>
                        <!--begin::Card-->
                        <div class="card" data-select2-id="select2-data-141-s38f">
                            ...
                            <div class="card-body" data-select2-id="select2-data-140-zqdv">
                                ...
                                <div class="mb-5" data-select2-id="select2-data-139-fp70">
                                    ...
                                    <select class="form-select" id="frontal_color" name="frontal_color"
                                        data-control="select2" data-placeholder="選択してください">
                                ...
                                <div class="mb-10">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid mb-5">
                                        <input class="form-check-input category_id" type="checkbox"
                                            onchange="checkCategoryCnt(this)" id="{{ $category->id }}"
                                            value="{{ $category->id }}">
...
<script>
    ...
    function checkCategoryCnt(e) {
        var checkboxes = $("input:checkbox:checked");
        // console.log(checkboxes);
        if(checkboxes.length == 3) {
            var uncheckboxes = $("input:checkbox:not(:checked)");
            // console.log(uncheckboxes)
            uncheckboxes.prop('disabled', true);
            // checkboxes.attr('disabled', true);
        } if(checkboxes.length >= 1 && checkboxes.length < 3) {
            var uncheckboxes = $("input:checkbox:not(:checked)");
            uncheckboxes.prop('disabled', false);
        }
    }
</script>
@endsection